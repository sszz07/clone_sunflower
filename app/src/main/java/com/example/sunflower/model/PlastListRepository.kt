...
import com.example.sunflower.retrofit.Constants
import com.example.sunflower.retrofit.RESPONSE_STATE
import com.example.sunflower.retrofit.RetrofitManager
...
class PlastListRepository {
    ...
    fun firstInsert(dbHelper: DBHelperFisrt) {
        ...
        val count = dbHelper.select(database)
